...
export function UmumSidebar() {
  return (
    <aside className="flex h-screen w-72 flex-col bg-orange-500 px-5 py-5 text-white">
      <div className="mb-8 rounded-3xl bg-white/15 p-4 ring-1 ring-white/20">
        <p className="text-sm font-bold">NutriSafe MBG</p>
        <p className="mt-1 text-xs text-orange-50">Dashboard Umum/Siswa</p>
      </div>
      ...
      <div className="mt-auto rounded-3xl bg-white/15 p-4 ring-1 ring-white/20">
        <p className="text-xs text-orange-50">Role aktif</p>
        <p className="mt-1 text-sm font-semibold">Umum/Siswa</p>
      </div>
    </aside>
  );
}
